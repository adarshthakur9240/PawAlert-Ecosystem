  ...
  return (
    <div className="flex flex-col min-h-screen bg-white dark:bg-[#0a0a0a] pb-24 text-gray-900 dark:text-white">
      ...
      <main className="p-4 space-y-8 max-w-2xl mx-auto w-full">
        {/* Points Hero - Fixed Gradient and Contrast */}
        <div className="relative overflow-hidden bg-gradient-to-br from-[#b33918] to-[#e55934] text-white p-8 rounded-[3rem] shadow-2xl shadow-primary/30">
        ...
        {/* Redemption Section - Theme Compatible */}
        <div className="space-y-4">
          <h2 className="text-xs font-black text-gray-500 dark:text-muted-foreground tracking-widest uppercase px-2">Redeem Points</h2>
          <div className="grid grid-cols-1 gap-4">
            {[
              ...
              <div key={idx} className="flex items-center justify-between p-5 bg-white border border-gray-200 shadow-sm dark:bg-[#1a1a1a] dark:border-transparent dark:shadow-none rounded-[2rem] group hover:border-primary/40 hover:bg-gray-50 dark:hover:bg-[#222] transition-all duration-300 cursor-pointer">
                <div className="flex items-center gap-4">
                  ...
                  <div className="space-y-0.5 text-left">
                    <h3 className="font-black text-sm text-gray-900 dark:text-white uppercase tracking-tight italic">{item.title}</h3>
                    <p className="text-[10px] text-gray-500 dark:text-slate-500 font-bold tracking-widest uppercase">{item.cost}</p>
                  </div>
                </div>
                <Button size="icon" variant="ghost" className="rounded-2xl group-hover:bg-primary group-hover:text-white transition-all">
                  <ArrowUpRight className="w-5 h-5 text-gray-300 dark:text-slate-700" />
                </Button>
              </div>
            ))}
          </div>
        ...
        <div className="p-6 border-2 border-dashed border-gray-200 dark:border-white/5 rounded-[2.5rem] bg-gray-50 dark:bg-[#1a1a1a]/50 flex flex-col items-center text-center space-y-2">
          <p className="text-xs font-black text-gray-400 dark:text-slate-500 uppercase tracking-widest">Next Goal</p>
          <p className="text-xs font-medium text-gray-500 dark:text-slate-400 max-w-[280px]">
