  ...
  return (
    <div className="flex flex-col min-h-screen bg-white dark:bg-[#0a0a0a] pb-24 text-gray-900 dark:text-white">
      ...
      <main className="p-4 space-y-8 max-w-2xl mx-auto w-full">
        {/* Wallet Card - Fixed for Theme Contrast */}
        <div className="bg-gray-900 text-white dark:bg-[#1a1a1a] p-6 rounded-[2.5rem] border border-white/5 relative overflow-hidden group shadow-2xl">
        ...
        {/* Saved Methods - Theme Compatible Cards */}
        <div className="space-y-4">
          <div className="flex items-center justify-between px-2">
            <h2 className="text-xs font-black text-gray-500 dark:text-muted-foreground tracking-widest uppercase px-2">Saved Methods</h2>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={idx} className="p-5 bg-white border border-gray-200 text-gray-900 dark:bg-[#111] dark:border-transparent dark:text-white rounded-[2rem] flex items-center justify-between group hover:border-primary/40 transition-all cursor-pointer shadow-sm dark:shadow-none">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-2xl bg-gray-100 dark:bg-white/5 flex items-center justify-center group-hover:scale-110 transition-transform">
                    <item.icon className={`w-6 h-6 ${item.color}`} />
                  </div>
                  <div>
                    <h3 className="font-black text-sm uppercase tracking-tight italic">{item.label}</h3>
                    <p className="text-[10px] text-gray-500 dark:text-slate-500 font-bold tracking-widest uppercase">{item.info}</p>
                  </div>
                </div>
                <ArrowUpRight className="w-4 h-4 text-gray-300 dark:text-slate-700 group-hover:text-primary transition-colors" />
              </div>
            ))}
          </div>
        </div>

        {/* Karma Cashback Banner - Theme Compatible */}
        <div className="p-6 bg-gray-100 dark:bg-[#1a1a1a] rounded-[2rem] border border-gray-200 dark:border-white/5 flex items-center justify-between">
          <div className="space-y-1 text-gray-900 dark:text-white">
            ...
            <p className="text-[10px] text-gray-500 dark:text-muted-foreground font-black uppercase tracking-wide max-w-[180px]">Earn up to 10% Karma on all PawStore purchases.</p>
          </div>
