      ...
      <main className="p-4 space-y-8 max-w-2xl mx-auto w-full">
        ...
        <div className="flex flex-col items-center text-center space-y-4 py-8">
          ...
          <div className="space-y-1">
            <h2 className="text-3xl font-black tracking-tighter uppercase italic text-gray-900 dark:text-white">
              Paw<span className="text-primary">Alert</span>
            </h2>
            <p className="text-[10px] font-black text-gray-500 dark:text-slate-500 uppercase tracking-[0.2em]">Version 2.4.0 (Build 89)</p>
          </div>
        </div>

        {/* Legal Links - Theme Compatible */}
        <div className="space-y-4">
          <h2 className="text-xs font-black text-gray-500 dark:text-muted-foreground tracking-widest uppercase px-2">Documentation</h2>
          <div className="space-y-3">
            {[
              ...
              <button key={idx} className="w-full p-5 bg-white border border-gray-200 shadow-sm dark:bg-[#1a1a1a] dark:border-transparent dark:shadow-none rounded-[2rem] flex items-center justify-between group hover:bg-gray-50 dark:hover:bg-[#222] transition-all">
                <div className="flex items-center gap-4">
                  ...
                  <span className="font-black text-sm uppercase tracking-tight italic text-gray-900 dark:text-white">{item.label}</span>
                </div>
                <Info className="w-5 h-5 text-gray-300 dark:text-slate-700 group-hover:text-primary transition-colors" />
              </button>
            ))}
          </div>
        </div>
        ...
        <div className="pt-8 text-center space-y-4">
          <p className="text-[10px] text-gray-400 dark:text-slate-600 font-black uppercase tracking-[0.3em]">Made with ❤️ for Animals</p>
          <p className="text-[9px] text-gray-400 dark:text-slate-700 font-bold uppercase tracking-widest leading-relaxed px-12">
