    ...
    <div className="flex flex-col min-h-screen bg-gray-50 pb-24 text-gray-900">
      ...
      <main className="p-4 space-y-8 max-w-2xl mx-auto w-full">
        ...
        <div className="space-y-4">
          <h2 className="text-xs font-black text-gray-500 tracking-widest uppercase px-2">Alert Preferences</h2>
        ...
        <div className="p-6 bg-white border border-gray-200 rounded-[2rem] shadow-sm text-center">
