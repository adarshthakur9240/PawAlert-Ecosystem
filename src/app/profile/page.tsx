      ...
      <main className="flex-1 p-4 space-y-8 max-w-4xl mx-auto w-full">
        ...
        <div className="flex flex-col items-center text-center space-y-4 pt-4">
          <div className="relative group">
            <div className="w-28 h-28 rounded-[2.5rem] bg-secondary flex items-center justify-center overflow-hidden border-4 border-background shadow-2xl">
              {user?.imageUrl ? (
            ...
            <div className="absolute -bottom-2 -right-2 bg-primary text-white p-2 rounded-2xl shadow-lg border-4 border-background">
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 font-bold tracking-widest uppercase">
          ...
          <div 
            ...
            className="flex items-center gap-2 px-4 py-2 bg-secondary rounded-2xl cursor-pointer hover:bg-secondary/80 transition-colors border border-border/50"
          >
        ...
        {recentOrders.length > 0 && (
          <div className="space-y-4">
            <h2 className="text-xs font-black tracking-[0.2em] text-muted-foreground uppercase px-2">
            ...
            <div className="flex gap-4 overflow-x-auto pb-4 no-scrollbar">
              {recentOrders.map((order) => (
                <div 
                  key={order.id}
                  className="shrink-0 w-64 bg-white dark:bg-[#1a1a1a] border border-gray-100 dark:border-white/5 rounded-3xl p-4 shadow-sm space-y-3"
                >
                  <div className="flex gap-3">
                    ...
                    <div className="flex-1 space-y-0.5">
                      <h4 className="text-xs font-black text-gray-900 dark:text-white line-clamp-1 uppercase">
                        {order.items}
                      </h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {menuItems.map((item, index) => (
              <Link key={index} href={item.href}>
                <button
                  className="group w-full flex items-center justify-between p-5 bg-white border border-gray-200 shadow-sm hover:bg-gray-50 dark:bg-[#1a1a1a] dark:border-transparent dark:hover:bg-[#222] dark:shadow-none rounded-[2rem] transition-all duration-300 text-left"
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-0.5">
                      ...
                      <p className="text-[10px] font-bold text-gray-500 dark:text-gray-400 tracking-wide uppercase">
                        {item.subtitle}
                      </p>
                    </div>
                  </div>
        ...
        <div className="pt-4 px-2">
          <SignOutButton>
            <button className="w-full p-5 flex items-center justify-center gap-3 bg-destructive/10 text-destructive rounded-[2rem] border border-destructive/20 hover:bg-destructive hover:text-white transition-all duration-300 font-black tracking-widest uppercase text-sm">
