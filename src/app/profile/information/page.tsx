    ...
    <div className="flex flex-col min-h-screen bg-gray-50 pb-24 text-gray-900">
      ...
      <main className="p-4 space-y-8 max-w-2xl mx-auto w-full">
        <div className="flex flex-col items-center space-y-4 py-4">
          <div className="w-24 h-24 rounded-[2rem] bg-white flex items-center justify-center border-4 border-white shadow-xl relative group">
          ...
          <p className="text-[10px] font-black text-gray-500 uppercase tracking-widest">Citizen Rescuer • Since 2024</p>
        </div>
          ...
          <div className="grid gap-4">
            <div className="space-y-2 px-1">
              ...
              <div className="relative">
                ...
                <Input defaultValue="Adarsh Singh" className="h-14 pl-12 bg-white border-gray-200 shadow-sm rounded-2xl font-bold text-gray-900 focus:ring-primary/20" />
              </div>
            </div>
            ...
            <div className="space-y-2 px-1">
              ...
              <div className="relative">
                ...
                <Input defaultValue="adarsh@pawalert.com" className="h-14 pl-12 bg-white border-gray-200 shadow-sm rounded-2xl font-bold text-gray-900 focus:ring-primary/20" />
              </div>
            </div>

            <div className="grid grid-cols-2 gap-4 px-1">
              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-500 ml-1">Phone</label>
                <div className="relative">
                  <Phone className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />
                  <Input defaultValue="+91 98765 43210" className="h-14 pl-12 bg-white border-gray-200 shadow-sm rounded-2xl font-bold text-gray-900 focus:ring-primary/20" />
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input defaultValue="Noida" className="h-14 pl-12 bg-white border-gray-200 shadow-sm rounded-2xl font-bold text-gray-900 focus:ring-primary/20" />
                </div>
              </div>
            </div>
          </div>
